# Mismanaged plastic waste per capita - Data package

This data package contains the data that powers the chart ["Mismanaged plastic waste per capita"](https://ourworldindata.org/grapher/mismanaged-plastic-waste-per-capita?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on March 02, 2026.
